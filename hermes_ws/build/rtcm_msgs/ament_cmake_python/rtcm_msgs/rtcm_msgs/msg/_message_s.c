...
bool rtcm_msgs__msg__message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rtcm_msgs.msg._message.Message", full_classname_dest, 30) == 0);
  }
  rtcm_msgs__msg__Message * ros_message = _ros_message;
  {  // header
  ...
  {  // message
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint8_t * dest = ros_message->message.data;
...
PyObject * rtcm_msgs__msg__message__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rtcm_msgs.msg._message");
  ...
  {  // message
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "message");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->message.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint8_t * src = &(ros_message->message.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->message.size * sizeof(uint8_t));
      assert(data != NULL);
