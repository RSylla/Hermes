...
#ifndef UBLOX_UBX_INTERFACES__SRV__DETAIL__COLD_START__FUNCTIONS_H_
#define UBLOX_UBX_INTERFACES__SRV__DETAIL__COLD_START__FUNCTIONS_H_
...
/// Initialize srv/ColdStart message.
/**
...
/// Finalize srv/ColdStart message.
/**
...
/// Create srv/ColdStart message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ublox_ubx_interfaces__srv__ColdStart_Request__init().
...
/// Destroy srv/ColdStart message.
/**
 * It calls
 * ublox_ubx_interfaces__srv__ColdStart_Request__fini()
...
/// Check for srv/ColdStart message equality.
/**
...
/// Initialize array of srv/ColdStart messages.
/**
...
/// Finalize array of srv/ColdStart messages.
/**
 * It calls
 * ublox_ubx_interfaces__srv__ColdStart_Request__fini()
...
/// Create array of srv/ColdStart messages.
/**
 * It allocates the memory for the array and calls
 * ublox_ubx_interfaces__srv__ColdStart_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ColdStart messages.
/**
 * It calls
 * ublox_ubx_interfaces__srv__ColdStart_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ColdStart message array equality.
/**
...
/// Copy an array of srv/ColdStart messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ublox_ubx_interfaces__srv__ColdStart_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ublox_ubx_interfaces
...
/**
 * It calls
 * ublox_ubx_interfaces__srv__ColdStart_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ublox_ubx_interfaces
...
/**
 * It allocates the memory for the array and calls
 * ublox_ubx_interfaces__srv__ColdStart_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ublox_ubx_interfaces
...
/**
 * It calls
 * ublox_ubx_interfaces__srv__ColdStart_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // UBLOX_UBX_INTERFACES__SRV__DETAIL__COLD_START__FUNCTIONS_H_
