...
static const _ResetODO_Request_type_support_symbol_names_t _ResetODO_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ublox_ubx_interfaces, srv, ResetODO_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_ubx_interfaces, srv, ResetODO_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ublox_ubx_interfaces, srv, ResetODO_Request)() {
  return &::ublox_ubx_interfaces::srv::rosidl_typesupport_c::ResetODO_Request_message_type_support_handle;
}
...
static const _ResetODO_Response_type_support_symbol_names_t _ResetODO_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ublox_ubx_interfaces, srv, ResetODO_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_ubx_interfaces, srv, ResetODO_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ublox_ubx_interfaces, srv, ResetODO_Response)() {
  return &::ublox_ubx_interfaces::srv::rosidl_typesupport_c::ResetODO_Response_message_type_support_handle;
}
...
static const _ResetODO_type_support_symbol_names_t _ResetODO_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ublox_ubx_interfaces, srv, ResetODO)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ublox_ubx_interfaces, srv, ResetODO)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ublox_ubx_interfaces, srv, ResetODO)() {
  return &::ublox_ubx_interfaces::srv::rosidl_typesupport_c::ResetODO_service_type_support_handle;
}
