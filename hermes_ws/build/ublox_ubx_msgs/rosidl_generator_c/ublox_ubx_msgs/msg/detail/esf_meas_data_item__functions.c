...
ublox_ubx_msgs__msg__ESFMeasDataItem__are_equal(const ublox_ubx_msgs__msg__ESFMeasDataItem * lhs, const ublox_ubx_msgs__msg__ESFMeasDataItem * rhs)
{
  ...
  // data_field
  if (lhs->data_field != rhs->data_field) {
    return false;
  }
  // data_type
  ...
  ublox_ubx_msgs__msg__ESFMeasDataItem * output)
{
  ...
  // data_field
  output->data_field = input->data_field;
  // data_type
...
ublox_ubx_msgs__msg__ESFMeasDataItem__create()
{
  ...
  ublox_ubx_msgs__msg__ESFMeasDataItem * msg = (ublox_ubx_msgs__msg__ESFMeasDataItem *)allocator.allocate(sizeof(ublox_ubx_msgs__msg__ESFMeasDataItem), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ublox_ubx_msgs__msg__ESFMeasDataItem));
  bool success = ublox_ubx_msgs__msg__ESFMeasDataItem__init(msg);
  if (!success) {
...
ublox_ubx_msgs__msg__ESFMeasDataItem__destroy(ublox_ubx_msgs__msg__ESFMeasDataItem * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ublox_ubx_msgs__msg__ESFMeasDataItem__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence__init(ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ublox_ubx_msgs__msg__ESFMeasDataItem * data = NULL;

  if (size) {
    data = (ublox_ubx_msgs__msg__ESFMeasDataItem *)allocator.zero_allocate(size, sizeof(ublox_ubx_msgs__msg__ESFMeasDataItem), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ublox_ubx_msgs__msg__ESFMeasDataItem__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ublox_ubx_msgs__msg__ESFMeasDataItem__fini(&data[i - 1]);
      }
...
ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence__fini(ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ublox_ubx_msgs__msg__ESFMeasDataItem__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence * array = (ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence *)allocator.allocate(sizeof(ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence__init(array, size);
  if (!success) {
...
ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence__destroy(ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence__are_equal(const ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence * lhs, const ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ublox_ubx_msgs__msg__ESFMeasDataItem__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ublox_ubx_msgs__msg__ESFMeasDataItem__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ublox_ubx_msgs__msg__ESFMeasDataItem);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ublox_ubx_msgs__msg__ESFMeasDataItem * data =
      (ublox_ubx_msgs__msg__ESFMeasDataItem *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ublox_ubx_msgs__msg__ESFMeasDataItem__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ublox_ubx_msgs__msg__ESFMeasDataItem__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ublox_ubx_msgs__msg__ESFMeasDataItem__copy(
