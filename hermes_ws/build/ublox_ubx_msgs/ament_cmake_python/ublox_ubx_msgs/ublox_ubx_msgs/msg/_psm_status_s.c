...
bool ublox_ubx_msgs__msg__psm_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._psm_status.PSMStatus", full_classname_dest, 40) == 0);
  }
  ublox_ubx_msgs__msg__PSMStatus * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of PSMStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._psm_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PSMStatus");
