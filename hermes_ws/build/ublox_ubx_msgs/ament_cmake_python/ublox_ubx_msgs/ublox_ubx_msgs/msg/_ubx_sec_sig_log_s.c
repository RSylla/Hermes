...
bool ublox_ubx_msgs__msg__sig_log_event__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * ublox_ubx_msgs__msg__sig_log_event__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool ublox_ubx_msgs__msg__ubx_sec_sig_log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._ubx_sec_sig_log.UBXSecSigLog", full_classname_dest, 48) == 0);
  }
  ublox_ubx_msgs__msg__UBXSecSigLog * ros_message = _ros_message;
  {  // header
  ...
  {  // events
    ...
    if (!ublox_ubx_msgs__msg__SigLogEvent__Sequence__init(&(ros_message->events), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ublox_ubx_msgs__msg__SigLogEvent__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ublox_ubx_msgs__msg__SigLogEvent * dest = ros_message->events.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ublox_ubx_msgs__msg__sig_log_event__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of UBXSecSigLog */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._ubx_sec_sig_log");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UBXSecSigLog");
  ...
  {  // events
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ublox_ubx_msgs__msg__sig_log_event__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
