...
bool ublox_ubx_msgs__msg__sat_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._sat_info.SatInfo", full_classname_dest, 36) == 0);
  }
  ublox_ubx_msgs__msg__SatInfo * ros_message = _ros_message;
  {  // gnss_id
  ...
  {  // flags
    ...
    if (!ublox_ubx_msgs__msg__sat_flags__convert_from_py(field, &ros_message->flags)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * ublox_ubx_msgs__msg__sat_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._sat_info");
  ...
  {  // flags
    PyObject * field = NULL;
    field = ublox_ubx_msgs__msg__sat_flags__convert_to_py(&ros_message->flags);
    if (!field) {
      return NULL;
    }
    {
