...
bool ublox_ubx_msgs__msg__gps_fix__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._gps_fix.GpsFix", full_classname_dest, 34) == 0);
  }
  ublox_ubx_msgs__msg__GpsFix * ros_message = _ros_message;
  {  // fix_type
...
PyObject * ublox_ubx_msgs__msg__gps_fix__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._gps_fix");
