...
bool ublox_ubx_msgs__msg__ubx_sec_uniqid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._ubx_sec_uniqid.UBXSecUniqid", full_classname_dest, 47) == 0);
  }
  ublox_ubx_msgs__msg__UBXSecUniqid * ros_message = _ros_message;
  {  // header
  ...
  {  // unique_id
    ...
    }
    {
      ...
      Py_ssize_t size = 5;
      uint8_t * dest = ros_message->unique_id;
...
{
  /* NOTE(esteve): Call constructor of UBXSecUniqid */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._ubx_sec_uniqid");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UBXSecUniqid");
  ...
  {  // unique_id
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "unique_id");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    uint8_t * src = &(ros_message->unique_id[0]);
