...
bool ublox_ubx_msgs__msg__utc_std__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._utc_std.UtcStd", full_classname_dest, 34) == 0);
  }
  ublox_ubx_msgs__msg__UtcStd * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of UtcStd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._utc_std");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UtcStd");
