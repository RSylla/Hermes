...
static const _ESFSensorStatus_type_support_symbol_names_t _ESFSensorStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_ubx_msgs, msg, ESFSensorStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ublox_ubx_msgs, msg, ESFSensorStatus)),
  }
};
...
{
  return &::ublox_ubx_msgs::msg::rosidl_typesupport_cpp::ESFSensorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ublox_ubx_msgs, msg, ESFSensorStatus)() {
  return get_message_type_support_handle<ublox_ubx_msgs::msg::ESFSensorStatus>();
}
