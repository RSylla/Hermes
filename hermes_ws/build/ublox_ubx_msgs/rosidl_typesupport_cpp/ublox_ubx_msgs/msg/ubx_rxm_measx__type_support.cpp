...
static const _UBXRxmMeasx_type_support_symbol_names_t _UBXRxmMeasx_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ublox_ubx_msgs, msg, UBXRxmMeasx)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ublox_ubx_msgs, msg, UBXRxmMeasx)),
  }
};
...
{
  return &::ublox_ubx_msgs::msg::rosidl_typesupport_cpp::UBXRxmMeasx_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ublox_ubx_msgs, msg, UBXRxmMeasx)() {
  return get_message_type_support_handle<ublox_ubx_msgs::msg::UBXRxmMeasx>();
}
