...
{
  new (message_memory) ublox_ubx_msgs::msg::MapMatching(_init);
}

void MapMatching_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ublox_ubx_msgs::msg::MapMatching *>(message_memory);
  typed_message->~MapMatching();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MapMatching_message_member_array[1] = {
  {
    "status",  // name
    ...
    offsetof(ublox_ubx_msgs::msg::MapMatching, status),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MapMatching_message_members = {
  ...
  1,  // number of fields
  sizeof(ublox_ubx_msgs::msg::MapMatching),
...
{
  return &::ublox_ubx_msgs::msg::rosidl_typesupport_introspection_cpp::MapMatching_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ublox_ubx_msgs, msg, MapMatching)() {
  return &::ublox_ubx_msgs::msg::rosidl_typesupport_introspection_cpp::MapMatching_message_type_support_handle;
}
