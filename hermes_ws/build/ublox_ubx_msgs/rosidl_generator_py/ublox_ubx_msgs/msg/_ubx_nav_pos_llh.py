...
class Metaclass_UBXNavPosLLH(type):
    """Metaclass of message 'UBXNavPosLLH'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'ublox_ubx_msgs.msg.UBXNavPosLLH')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__ubx_nav_pos_llh
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__ubx_nav_pos_llh
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__ubx_nav_pos_llh
            cls._TYPE_SUPPORT = module.type_support_msg__msg__ubx_nav_pos_llh
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__ubx_nav_pos_llh
...
class UBXNavPosLLH(metaclass=Metaclass_UBXNavPosLLH):
    """Message class 'UBXNavPosLLH'."""
