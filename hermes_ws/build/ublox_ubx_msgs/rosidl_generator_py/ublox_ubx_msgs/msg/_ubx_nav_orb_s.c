...
bool ublox_ubx_msgs__msg__ubx_nav_orb__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._ubx_nav_orb.UBXNavOrb", full_classname_dest, 41) == 0);
  }
  ublox_ubx_msgs__msg__UBXNavOrb * ros_message = _ros_message;
  {  // header
  ...
  {  // sv_info
    ...
    if (!ublox_ubx_msgs__msg__OrbSVInfo__Sequence__init(&(ros_message->sv_info), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create ublox_ubx_msgs__msg__OrbSVInfo__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    ublox_ubx_msgs__msg__OrbSVInfo * dest = ros_message->sv_info.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!ublox_ubx_msgs__msg__orb_sv_info__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of UBXNavOrb */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._ubx_nav_orb");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UBXNavOrb");
  ...
  {  // sv_info
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = ublox_ubx_msgs__msg__orb_sv_info__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
