...
class Metaclass_RawxData(type):
    """Metaclass of message 'RawxData'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__rawx_data
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__rawx_data
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__rawx_data
            cls._TYPE_SUPPORT = module.type_support_msg__msg__rawx_data
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__rawx_data

            from ublox_ubx_msgs.msg import TrkStat
            if TrkStat.__class__._TYPE_SUPPORT is None:
                TrkStat.__class__.__import_type_support__()
...
class RawxData(metaclass=Metaclass_RawxData):
    """Message class 'RawxData'."""
    ...
    _fields_and_field_types = {
        ...
        'cp_stdev': 'uint8',
        'do_stdev': 'uint8',
        'trk_stat': 'ublox_ubx_msgs/TrkStat',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.BasicType('uint8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['ublox_ubx_msgs', 'msg'], 'TrkStat'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from ublox_ubx_msgs.msg import TrkStat
        self.trk_stat = kwargs.get('trk_stat', TrkStat())
    ...
    def trk_stat(self, value):
        if __debug__:
            from ublox_ubx_msgs.msg import TrkStat
            assert \
                isinstance(value, TrkStat), \
                "The 'trk_stat' field must be a sub message of type 'TrkStat'"
