...
bool ublox_ubx_msgs__msg__psmpvt__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._psmpvt.PSMPVT", full_classname_dest, 33) == 0);
  }
  ublox_ubx_msgs__msg__PSMPVT * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of PSMPVT */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._psmpvt");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PSMPVT");
