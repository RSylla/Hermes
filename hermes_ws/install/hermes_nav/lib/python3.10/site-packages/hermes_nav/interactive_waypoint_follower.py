...
class InteractiveGpsWpCommander(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("InteractiveGpsWpCommander node has been initialized")
    ...
    def mapviz_wp_cb(self, msg: PointStamped):
        ...
        """
        self.get_logger().info(f"Received point: {msg.point.x}, {msg.point.y}, {msg.point.z} with frame_id: {msg.header.frame_id}")
