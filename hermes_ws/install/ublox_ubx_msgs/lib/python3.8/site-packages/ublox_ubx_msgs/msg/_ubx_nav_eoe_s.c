...
bool ublox_ubx_msgs__msg__ubx_nav_eoe__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._ubx_nav_eoe.UBXNavEOE", full_classname_dest, 41) == 0);
  }
  ublox_ubx_msgs__msg__UBXNavEOE * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of UBXNavEOE */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._ubx_nav_eoe");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UBXNavEOE");
