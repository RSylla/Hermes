...
bool ublox_ubx_msgs__msg__orb_sv_flag__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._orb_sv_flag.OrbSVFlag", full_classname_dest, 41) == 0);
  }
  ublox_ubx_msgs__msg__OrbSVFlag * ros_message = _ros_message;
  {  // health
  ...
  {  // visibility
    ...
    assert(PyLong_Check(field));
    ros_message->visibility = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of OrbSVFlag */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._orb_sv_flag");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "OrbSVFlag");
  ...
  {  // visibility
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->visibility);
    {
