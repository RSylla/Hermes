...
bool ublox_ubx_msgs__msg__carr_soln__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._carr_soln.CarrSoln", full_classname_dest, 38) == 0);
  }
  ublox_ubx_msgs__msg__CarrSoln * ros_message = _ros_message;
  {  // status
...
{
  /* NOTE(esteve): Call constructor of CarrSoln */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._carr_soln");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CarrSoln");
