...
bool ublox_ubx_msgs__msg__rawx_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._rawx_data.RawxData", full_classname_dest, 38) == 0);
  }
  ublox_ubx_msgs__msg__RawxData * ros_message = _ros_message;
  {  // pr_mes
  ...
  {  // trk_stat
    ...
    if (!ublox_ubx_msgs__msg__trk_stat__convert_from_py(field, &ros_message->trk_stat)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of RawxData */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._rawx_data");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RawxData");
  ...
  {  // trk_stat
    PyObject * field = NULL;
    field = ublox_ubx_msgs__msg__trk_stat__convert_to_py(&ros_message->trk_stat);
    if (!field) {
      return NULL;
    }
    {
