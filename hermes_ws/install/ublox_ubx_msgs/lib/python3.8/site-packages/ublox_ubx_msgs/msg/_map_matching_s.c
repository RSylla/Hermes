...
bool ublox_ubx_msgs__msg__map_matching__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._map_matching.MapMatching", full_classname_dest, 44) == 0);
  }
  ublox_ubx_msgs__msg__MapMatching * ros_message = _ros_message;
  {  // status
...
PyObject * ublox_ubx_msgs__msg__map_matching__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._map_matching");
