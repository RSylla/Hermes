...
bool ublox_ubx_msgs__msg__ubx_nav_pos_llh__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._ubx_nav_pos_llh.UBXNavPosLLH", full_classname_dest, 48) == 0);
  }
  ublox_ubx_msgs__msg__UBXNavPosLLH * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of UBXNavPosLLH */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._ubx_nav_pos_llh");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UBXNavPosLLH");
