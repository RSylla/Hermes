...
bool ublox_ubx_msgs__msg__esf_meas_data_item__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._esf_meas_data_item.ESFMeasDataItem", full_classname_dest, 54) == 0);
  }
  ublox_ubx_msgs__msg__ESFMeasDataItem * ros_message = _ros_message;
  {  // data_field
    PyObject * field = PyObject_GetAttrString(_pymsg, "data_field");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->data_field = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // data_type
...
{
  /* NOTE(esteve): Call constructor of ESFMeasDataItem */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._esf_meas_data_item");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ESFMeasDataItem");
  ...
  {  // data_field
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->data_field);
    {
      int rc = PyObject_SetAttrString(_pymessage, "data_field", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
