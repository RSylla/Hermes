...
bool ublox_ubx_msgs__msg__ubx_nav_odo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._ubx_nav_odo.UBXNavOdo", full_classname_dest, 41) == 0);
  }
  ublox_ubx_msgs__msg__UBXNavOdo * ros_message = _ros_message;
  {  // header
  ...
  {  // distance
    ...
    assert(PyLong_Check(field));
    ros_message->distance = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // total_distance
    ...
    assert(PyLong_Check(field));
    ros_message->total_distance = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // distance_std
    PyObject * field = PyObject_GetAttrString(_pymsg, "distance_std");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->distance_std = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of UBXNavOdo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._ubx_nav_odo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "UBXNavOdo");
  ...
  {  // total_distance
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->total_distance);
    {
  ...
  {  // distance_std
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->distance_std);
    {
      int rc = PyObject_SetAttrString(_pymessage, "distance_std", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
