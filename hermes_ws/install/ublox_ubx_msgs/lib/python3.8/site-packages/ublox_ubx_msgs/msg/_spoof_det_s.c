...
bool ublox_ubx_msgs__msg__spoof_det__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ublox_ubx_msgs.msg._spoof_det.SpoofDet", full_classname_dest, 38) == 0);
  }
  ublox_ubx_msgs__msg__SpoofDet * ros_message = _ros_message;
  {  // state
...
{
  /* NOTE(esteve): Call constructor of SpoofDet */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ublox_ubx_msgs.msg._spoof_det");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpoofDet");
