...
static rosidl_typesupport_introspection_c__MessageMember ublox_ubx_msgs__msg__UBXSecSig__rosidl_typesupport_introspection_c__UBXSecSig_message_member_array[6] = {
  {
    "header",  // name
